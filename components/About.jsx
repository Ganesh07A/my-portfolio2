export default function About() {
  const tools = [
    { name: "Python", icon: "/assets/Python.png" }, // You'll need to add a python.png to your assets
    { name: "React", icon: "/assets/react.svg" }, // You'll need to add a python.png to your assets
  ...
  const data = [
    {
      ...
      description: "Python, JavaScript, SQL, HTML, CSS", // Updated to include Python
    },
    {
      name: "Education",
      icon1: "/assets/edu-icon.png",
      icon2: "/assets/edu-icon-dark.png",
      description: "B.Tech in Computer Science", // Keep or update if you have a specific specialization
    },
    {
      name: "Projects",
      icon1: "/assets/project-icon.png",
      icon2: "/assets/project-icon-dark.png",
      description: "Built AI Chatbots & Full Stack Apps", // More specific to your AI interest
    },
  ];
  return (
