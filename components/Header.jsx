...
export default function Header() {
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            <img src="/assets/pofile-pic.jpg" alt="" className="rounded-full w-32" />
            ...
            <p className="max-w-2xl mx-auto font-Ovo">I am a Full Stack Developer & AI Enthusiast. Building scalable web apps and intelligent systems.</p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
                ...
                <Link href="../assets/Ganesh-Suvarnakar-Resume.pdf" download
